...
define config.name = _("project engineer")
...
define gui.about = _p("""
Игру создала команда ГеймМастерс
Програмист - Горбатенко Данил
Тимлидер - Пичугин Максим
Дизайнер - Щербатых Кирилл
Гейм-Дизайнер - Мухин Антон
Аналитик - Коренков Денис
""")
...
define build.name = "project_engineer"
...
define config.main_menu_music = "audio/tittle.mp3"
...
define config.save_directory = "da-1666508011"
