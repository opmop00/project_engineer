...
label splashscreen:
    ...
    $ renpy.movie_cutscene('images/Menu_start.ogv')
...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(177,406,303,59) action Start()
        hotspot(177,476,303,59) action ShowMenu("preferences")
        hotspot(177,544,303,59) action ShowMenu("load")
        hotspot(177,784,303,59) action Quit(confirm=True)
